...
class ZoneController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            $request->validate([
                ...
                "area.gt" => "El ára de la zona debe ser mayor a 0",
            ]);
    ...
    public function update(Request $request, string $id)
    {
        try {
            $request->validate([
                ...
                "name.unique" => "El nombre ya ha sido registrado.",
                "area.gt" => "El área de la zona debe ser mayor a 0"
            ]);
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return response()->json(['message' => 'Error al eliminar la zona, porque tiene coordenadas asignadas.'], 500);
        }
    }
}
